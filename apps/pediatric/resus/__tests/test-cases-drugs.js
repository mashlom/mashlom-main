...
module.exports = [
    ...
    { childWeight: 5, drugName: 'Ketamin 1mg', drugType: 'IV', dosage: 1, expectedResult: { totalDose: 5, volume: 0.5 } },
    { childWeight: 5, drugName: 'Ketamin 1.5mg', drugType: 'IV', dosage: 1.5, expectedResult: { totalDose: 7.5, volume: 0.75 } },
    ...
    { childWeight: 25, drugName: 'Ketamin 1mg', drugType: 'IV', dosage: 1, expectedResult: { totalDose: 25, volume: 2.5 } },
    { childWeight: 25, drugName: 'Ketamin 1.5mg', drugType: 'IV', dosage: 1.5, expectedResult: { totalDose: 37.5, volume: 3.75 } },
