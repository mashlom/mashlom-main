...
module.exports = [
    ...
    { childWeight: 5, drugName: 'Suxamethonium (scoline)', drugType: 'IV ', dosage: 1, expectedResult: { totalDose: 5, volume: 0.5 } },
    ...
    { childWeight: 5, drugName: 'Manitol 20%', drugType: 'IV', dosage: 1, expectedResult: { totalDose: 5, volume: 25 } },
    ...
    { childWeight: 25, drugName: 'Suxamethonium (scoline)', drugType: 'IV ', dosage: 1, expectedResult: { totalDose: 25, volume: 2.5 } },
    ...
    { childWeight: 25, drugName: 'Manitol 20%', drugType: 'IV', dosage: 1, expectedResult: { totalDose: 25, volume: 125 } },
